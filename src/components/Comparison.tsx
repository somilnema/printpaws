        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          ...
          <div className="w-full lg:w-2/3">
            <div className="relative overflow-x-auto lg:overflow-visible">
              <table className="w-full text-left border-separate border-spacing-y-0 min-w-[500px]">
                <thead>
                  <tr className="text-[10px] md:text-xs font-black uppercase tracking-widest text-[#1a1a1b]">
                    <th className="py-4 px-4"></th>
                    <th className="py-4 px-6 text-center bg-primary text-white rounded-t-2xl shadow-[0_-5px_15px_rgba(168,123,98,0.1)]">
                      Prints By Paws
                    </th>
                    <th className="py-4 px-6 text-center text-gray-400">Others</th>
                  </tr>
                </thead>
                <tbody className="bg-white/50">
                  {COMPARISON_DATA.map((row, idx) => (
                    ...
                    >
                      <td className="py-3 px-4 font-bold text-[#1a1a1b] text-xs md:text-sm border-b border-gray-50 uppercase">
                        {row.feature}
                      </td>
                      <td className="py-3 px-6 text-center bg-primary/90 text-white shadow-[5px_0_15px_rgba(168,123,98,0.05),-5px_0_15px_rgba(168,123,98,0.05)] border-b border-white/10">
                      ...
                      <td className="py-3 px-6 text-center border-b border-gray-50">
                        <div className="flex justify-center scale-90">
                          {row.others ? (
